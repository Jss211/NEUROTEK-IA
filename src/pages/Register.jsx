...
function SocialBtn({ children, label }) {
  return (
    <button type="button" aria-label={label} className="flex items-center justify-center w-14 h-12 border border-gray-200 rounded-md hover:bg-gray-50 transition">
      {children}
    </button>
  )
}
